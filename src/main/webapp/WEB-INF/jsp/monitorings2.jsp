            ...
            <div class="card-body">
                ...
                <fieldset class="form-group col-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body markBody minHeight180 p-0" id="filters">                   
                                <div class="filter-body">
                                    <div class="filters row">
                                        <div class="filter all_filter col-md-4">
                                            <h4 class=""><spring:message code="monitorings2.filtersAll"/></h4>
                                            <div class="add-filter form-group row">                                                
                                                <label for="all_filter" class="all_filter col-form-label col-md-4 col-12 text-right"><spring:message code="monitorings2.addFilter"/></label>
                                                <div class="col-md-8 col-12">
                                                <select class="add_filter_select" id="allfilter">
                                                    <option value="">&nbsp;</option>
                                                    <option value="info.name" fname="<spring:message code="metricName"/>" alias="metric"><spring:message code="metricName"/></option>
                                                    <option value="level" fname="<spring:message code="level"/>" alias="level"><spring:message code="level"/></option>                                
                                                    <optgroup label="<spring:message code="tags"/>">
                                        ...
                                        <div class="filter ml_filter col-md-4">
                                            <h4 class=""><spring:message code="monitorings2.filtersMachine"/></h4>
                                            <div class="add-filter form-group row">
                                                <label for="ml_filter" class="all_filter col-form-label col-md-4 col-12 text-right"><spring:message code="monitorings2.addFilter"/></label>
                                                <div class="col-md-8 col-12">
                                                    <select class="add_filter_select" id="mlfilter">
                                                        <option value="">&nbsp;</option>
                                                        <option value="info.name" fname="<spring:message code="metricName"/>" alias="metric"><spring:message code="metricName"/></option>
                                                        <option value="level" fname="<spring:message code="level"/>" alias="level"><spring:message code="level"/></option>                                
                                                        <optgroup label="<spring:message code="tags"/>">
                                        ...
                                        <div class="filter manual_filter col-md-4">
                                            <h4 class=""><spring:message code="monitorings2.filtersManually"/></h4>
                                            <div class="add-filter form-group row">
                                                <label for="manual_filter" class="all_filter col-form-label col-md-4 col-12 text-right"><spring:message code="monitorings2.addFilter"/></label>
                                                <div class="col-md-8 col-12">
                                                    <select class="add_filter_select col-sm-8" id="manualfilter">
                                                        <option value="">&nbsp;</option>
                                                        <option value="info.name" fname="<spring:message code="metricName"/>" alias="metric"><spring:message code="metricName"/></option>
                ...
                <fieldset class="form-group col-lg-6 col-12 pr-lg-0">
                    <div class="card shadow">
                        ...
                        <div class="card-body markBody minHeight180" id="options">                           
                                <div class="filter-body table-responsive">
                                    <table class="table table-striped options" style="width: 100%">
                                        <tbody><tr>
                                                <td class="card-fields name">
                                                    <label class="col-form-label"><spring:message code="monitorings2.displayFields"/></label>
                                                </td>
                                                <td class="card-fields value">
                                                    <select name="f_col[]" multiple="multiple" class="f_col"  style="width: 100%">
                                                        <option value="actions" label="actions" key="actions"><spring:message code="monitorings2.displayFieldsActions"/></option>
                ...
                <fieldset class="form-group col-lg-6 col-12 pl-lg-0">    
                    <div class="card shadow">
                        ...
                        <div class="card-body markBody minHeight180" id="notifiers">
                            <div class="filter-body">
                                <div class="add-notifier row">
                                    <label for="addNotifier" class="all_filter col-form-label col-md-4 col-12 text-right"><spring:message code="monitorings2.addNotifier"/></label>
                                    <div class="col-md-8 col-12">
                                        <select class="add_notifier_select" id="addNotifier">
                                            <option value="">&nbsp;</option>
                                            <option value="email" fname="<spring:message code="monitorings2.addressEmail"/>"><spring:message code="monitorings2.addNotifierEmail"/></option>
                                            <option value="telegram"  fname="<spring:message code="monitorings2.chatIdTelegram"/>"><spring:message code="monitorings2.addNotifierTelegram"/></option>                                
                                        </select>
...
<div class="row">
    <div class="col-12 ">
        <div class="x_panel">
            <div id="query_form_content">
                <form class="form-options form-row">
                    <fieldset class="collapsible collapsed col-12">                        
                        <legend><i class="action fa fas fa-chevron-down"></i><spring:message code="monitorings2.filters"/></legend>
                        <div class="filter-body">
                            <div class="filters row">
                                <div class="filter all_filter col-md-4">
                                    <h4 class=""><spring:message code="monitorings2.filtersAll"/></h4>
                                    <div class="add-filter">
                                        <label for="all_filter" class="all_filter col-md-4 text-right"><spring:message code="monitorings2.addFilter"/></label>
                                        <select class="add_filter_select col-md-8" id="allfilter">
                                            <option value="">&nbsp;</option>
                                            <option value="info.name" fname="<spring:message code="metricName"/>" alias="metric"><spring:message code="metricName"/></option>
                                            <option value="level" fname="<spring:message code="level"/>" alias="level"><spring:message code="level"/></option>                                
                                            <optgroup label="<spring:message code="tags"/>">
                                ...
                                <div class="filter ml_filter col-md-4">
                                    <h4 class=""><spring:message code="monitorings2.filtersMachine"/></h4>
                                    <div class="add-filter">
                                        <label for="ml_filter" class="all_filter col-md-4 text-right"><spring:message code="monitorings2.addFilter"/></label>
                                        <select class="add_filter_select col-md-8" id="mlfilter">
                                            <option value="">&nbsp;</option>
                                            <option value="info.name" fname="<spring:message code="metricName"/>" alias="metric"><spring:message code="metricName"/></option>
                                            <option value="level" fname="<spring:message code="level"/>" alias="level"><spring:message code="level"/></option>                                
                                            <optgroup label="<spring:message code="tags"/>">
                                ...
                                <div class="filter manual_filter col-md-4">
                                    <h4 class=""><spring:message code="monitorings2.filtersManually"/></h4>
                                    <div class="add-filter">
                                        <label for="manual_filter" class="all_filter col-md-4 text-right"><spring:message code="monitorings2.addFilter"/></label>
                                        <select class="add_filter_select col-md-8" id="manualfilter">
                                            <option value="">&nbsp;</option>
                                            <option value="info.name" fname="<spring:message code="metricName"/>" alias="metric"><spring:message code="metricName"/></option>
                                            <option value="level" fname="<spring:message code="level"/>" alias="level"><spring:message code="level"/></option>                                
                                            <optgroup label="<spring:message code="tags"/>">
                    ...
                    <fieldset class="collapsible collapsed col-lg-6 col-12">
                        <legend> <i class="action fa fas fa-chevron-down"></i><spring:message code="monitorings2.options"/></legend>
                        <div class="filter-body">
                            <table class="options" style="width: 100%">
                                <tbody><tr>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card shadow w-100 mb-2">
                    <div class="card-header btn-toolbar p-1" role="toolbar" aria-label="Toolbar with button groups"> 
