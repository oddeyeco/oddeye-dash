...
<div class="form-group">
    <label class="col-md-12 col-sm-12 col-xs-12" for="metric_input">Metric <input type="checkbox" class="js-switch-small filter-switch"  name="check_metric" value="metric"/> </label>
    ...
    <label class="col-md-12 col-sm-12 col-xs-12 taglabel">By Tag <button class="btn btn-success addtagq btn-xs" type="button">Edit tag filer</button></label> 
