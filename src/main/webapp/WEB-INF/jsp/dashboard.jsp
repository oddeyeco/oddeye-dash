...
<div role="tabpanel" id="tabpanel">                
    <ul id="formTab" class="nav nav-tabs bar_tabs" role="tablist">
        <li role="presentation">
            <a href="#tab_general" id="general-tab" role="tab" data-toggle="tab">General</a>
        </li>
        <li role="presentation" class="active">
            <a href="#tab_metric" id="metrics-tab" role="tab" data-toggle="tab">Metrics</a>
        </li>
        <li role="presentation">
            <a href="#tab_axes" id="axes-tab" role="tab" data-toggle="tab">Axes</a>
        </li>
        <li role="presentation">
            <a href="#tab_data_zoom" id="data_zoom_tab" role="tab" data-toggle="tab">Data Zoom</a>
        </li>
        <li role="presentation">
            <a href="#tab_legend" id="legend-tab" role="tab" data-toggle="tab">Legend</a>            
        </li>
        <li role="presentation">
            <a href="#tab_display" id="display-tab" role="tab" data-toggle="tab">Display</a>
        </li>
        <li role="presentation">
            <a href="#tab_time" id="time-tab" role="tab" data-toggle="tab">Time Range</a>
        </li>
        <li role="presentation">
            <a href="#tab_json" id="json-tab" role="tab" data-toggle="tab">Json</a>
        </li>
    </ul>
    <div id="TabContent" class="tab-content">
                        ...
                        <div class="form_main_block" key_path="options.yAxis">
                            <form class="form-horizontal form-label-left edit-axes" template_index="0" id="0_yaxes">
                                ...
                                <div class="form-group">
                                    <label class="control-label control-label-custom-legend" for="axes_color_y">Y color</label>
                                    <div class="titile_input_midle axes_select">
                                        <div class="input-group cl_picer cl_picer_input hasdublicatepath colorpicker-element">
                                            <input class="form-control" template_index="0" id="0_ycolor" type="text" prop_key="ycolor" name="ycolor" key_path="axisLine.lineStyle.color">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="lable_size_y">Font Size Label</label>
                                    <input class="form-control axes_select axis_input-size" template_index="0" id="0_label_size_y" type="number" prop_key="size_x" name="lable_size_y" key_path="axisLabel.fontSize">
                                    <label class="control-label control-label-custom-legend axis_lable-size" for="text_size_x">Text</label>
                                    <input class="form-control axes_select axis_input-size" template_index="0" id="0_text_size_y" type="number" prop_key="text_size_y" name="text_size_y" key_path="nameTextStyle.fontSize">
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="axes_unit_y">Unit</label>
                                    <select class="form-control axes_select select2-hidden-accessible" template_index="0" id="0_axes_unit_y" prop_key="unit" name="axes_unit_y" key_path="unit" tabindex="-1" aria-hidden="true">
                                        <optgroup label="None">
                                        ...
                                        <optgroup label="Currency">
                                            ...
                                            <option value="{value} руб.">Rubles (руб)</option>
                                        </optgroup>
                                        <optgroup label="Time">                                                            
                                        ...
                                        </optgroup><optgroup label="Velocity">
                                            <option value="{value} m/s">m/s</option>
                                            <option value="{value} km/h">km/h</option>
                                            <option value="{value} mph">mph</option>
                                            <option value="{value} kn">knot</option>
                                        </optgroup><optgroup label="Volume">
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-0_axes_unit_y-container">
                                                <span class="select2-selection__rendered" id="select2-0_axes_unit_y-container" title="None">None</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="axes_min_y">Y-Min</label>
                                    <input class="form-control title_input_small" template_index="0" id="0_axes_min_y" type="number" prop_key="min" name="axes_min_y" key_path="min">
                                    <label class="control-label control-label-custom-axes" for="axes_max_y">Y-Max</label>
                                    <input class="form-control title_input_small" template_index="0" id="0_axes_max_y" type="number" prop_key="max" name="axes_max_y" key_path="max">
                                </div>
                                <div class="btn btn-success dublicateq btn-xs" template_index="0" id="0_dublicateaxesy">Dublicate</div>
                                <div class="btn btn-danger removeq btn-xs" template_index="0" id="0_removeaxesy">Remove</div>
                            </form>
                            <button class="btn btn-success Addq btn-xs" id="addq" key_path="options.yAxis">Add</button>
                        </div>
                    </div>
                </div>
                <section class="form_main_block pull-left" id="edit_x">
                    <div class="form_main_block">
                        <h3><label class="control-label">X axes</label></h3>
                        <div class="form_main_block" key_path="options.xAxis">
                            <form class="form-horizontal form-label-left edit-axes" template_index="0" id="0_xaxes">
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="axes_show_x">Show</label>
                                    <input class="js-switch-small axes_show_x" template_index="0" id="0_axes_show_x" type="checkbox" prop_key="show" name="axes_show_x" key_path="show" checked="checked" data-switchery="true" style="display: none;">
                                    <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                        <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small>
                                    </span>
                                </div>
                                <div class="form-group form-group-custom"><label class="control-label control-label-custom-legend" for="axes_name_x">Text</label>
                                    <input class="form-control axes_select" template_index="0" id="0_axes_name_x" type="text" prop_key="name" name="axes_name_x" key_path="name">
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="axes_position_x">Position</label>
                                    <select class="form-control axes_select select2-hidden-accessible" template_index="0" id="0_axes_position_x" prop_key="position" name="axes_position_x" key_path="position" tabindex="-1" aria-hidden="true">
                                        <option value="">&nbsp;</option>
                                        <option value="bottom">Bottom</option>
                                        <option value="top">Top</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-0_axes_position_x-container">
                                                <span class="select2-selection__rendered" id="select2-0_axes_position_x-container" title="&nbsp;">&nbsp;</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="axes_splitNumber_x">Split Number</label>
                                    <input class="form-control axes_select" template_index="0" id="0_splitNumber_x" type="number" prop_key="splitNumber" name="splitNumber_x" key_path="splitNumber">
                                </div>
                                <div class="form-group">
                                    <label class="control-label control-label-custom-legend" for="axes_color_x">X color</label>
                                    <div class="titile_input_midle axes_select">
                                        <div class="input-group cl_picer cl_picer_input hasdublicatepath colorpicker-element">
                                            <input class="form-control axes_select" template_index="0" id="0_xcolor" type="text" prop_key="xcolor" name="xcolor" key_path="axisLine.lineStyle.color">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="lable_size_x">Font Size Label</label>
                                    <input class="form-control axes_select axis_input-size" template_index="0" id="0_label_size_x" type="number" prop_key="size_x" name="lable_size_x" key_path="axisLabel.fontSize">
                                    <label class="control-label control-label-custom-legend axis_lable-size" for="text_size_x">Text</label>
                                    <input class="form-control axes_select axis_input-size" template_index="0" id="0_text_size_x" type="number" prop_key="text_size_x" name="text_size_x" key_path="nameTextStyle.fontSize">
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="axes_mode_x">Scale</label>
                                    <select class="form-control axes_select select2-hidden-accessible" template_index="0" id="0_axes_mode_x" prop_key="type" name="axes_mode_x" key_path="type" tabindex="-1" aria-hidden="true">
                                        <option value="time">Time</option>
                                        <option value="category">Series</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-0_axes_mode_x-container">
                                                <span class="select2-selection__rendered" id="select2-0_axes_mode_x-container" title="Time">Time</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="form-group form-group-custom only-Series" style="display: none;">
                                    <label class="control-label control-label-custom-legend" for="axes_value_x">Value</label>
                                    <select class="form-control axes_select select2-hidden-accessible" template_index="0" id="0_axes_value_x" prop_key="m_sample" name="axes_value_x" key_path="m_sample" tabindex="-1" aria-hidden="true">
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-0_axes_value_x-container">
                                                <span class="select2-selection__rendered" id="select2-0_axes_value_x-container"></span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="btn btn-success dublicateq btn-xs" template_index="0" id="0_dublicateaxesx">Dublicate</div>
                                <div class="btn btn-danger removeq btn-xs" template_index="0" id="0_removeaxesx">Remove</div>
                            </form>
                            <button class="btn btn-success Addq btn-xs" id="addq" key_path="options.xAxis">Add</button>
                        </div>
                    </div>
                </section>
            </div>
        </div>
        <div role="tabpanel" class="tab-pane fade in" id="tab_data_zoom" aria-labelledby="data_zoom_tab">
            <div class="row">
                <div class="forms" id="edit_data_zoom">
                    <div class="form_main_block">
                        <div class="form_main_block" key_path="options.dataZoom">
                            <form class="form-horizontal form-label-left edit-datazoom pull-left" template_index="0" id="0_data_zoom">
                                <div class="form-group form-group-custom forslider" style="display: none;">
                                    <label class="control-label control-label-custom-legend" for="data_zoom_show">Show</label>
                                    <input class="js-switch-small data_zoom_show" template_index="0" id="0_data_zoom_show" type="checkbox" prop_key="show" name="data_zoom_show" key_path="show" checked="checked" data-switchery="true" style="display: none;">
                                    <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                        <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small></span>
                                </div>
                                <div class="form-group form-group-custom forinside">
                                    <label class="control-label control-label-custom-legend" for="data_zoom_disabled">Disabled</label>
                                    <input class="js-switch-small data_zoom_disabled" template_index="0" id="0_data_zoom_disabled" type="checkbox" prop_key="disabled" name="data_zoom_disabled" key_path="disabled" data-switchery="true" style="display: none;">
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="datazoom_start">Start %</label>
                                    <input class="form-control title_input_small" template_index="0" id="0_datazoom_start" type="number" min="0" max="100" prop_key="start" name="datazoom_start" key_path="start">
                                    <label class="control-label control-label-custom-axes" for="datazoom_end">End %</label>
                                    <input class="form-control title_input_small" template_index="0" id="0_datazoom_end" type="number" min="0" max="100" prop_key="end" name="datazoom_end" key_path="end">
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="datazoom_type">Type</label>
                                    <select class="form-control query_input datazoom_type_width select2-hidden-accessible" template_index="0" id="0_datazoom_type" prop_key="type" name="datazoom_type" key_path="type" tabindex="-1" aria-hidden="true">
                                        <option value="slider">Scroll</option>
                                        <option value="inside">Inner</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 200px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-0_datazoom_type-container">
                                                <span class="select2-selection__rendered" id="select2-0_datazoom_type-container" title="Inner">Inner</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="data_zoom_xAxisIndex">XaxisIndex</label>
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="data_zoom_yAxisIndex">YaxisIndex</label>
                                    <div template_index="0" id="0_data_zoom_yAxisIndex" type="choose_array" name="data_zoom_yAxisIndex" style="display:inline-block" key_path="yAxisIndex">
                                        <span>0<div class="icheckbox_flat-green" style="position: relative;">
                                                <input type="checkbox" index="0" class="flat" ,="" name="data_zoom_yAxisIndex[]" style="position: absolute; opacity: 0;">
                                                <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                                            </div>
                                        </span>
                                    </div>
                                </div>
                                <div class="btn btn-success dublicateq btn-xs pull-right" template_index="0" id="0_dublicatedatazoom">Dublicate</div>
                                <div class="btn btn-danger removeq btn-xs pull-right" template_index="0" id="0_removedatazoom">Remove</div>
                            </form>
                            <button class="btn btn-success Addq btn-xs" id="addq" key_path="options.dataZoom">Add</button>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div role="tabpanel" class="tab-pane fade in" id="tab_legend" aria-labelledby="legend-tab">
            <div class="row">
                <div class="form-horizontal form-label-left edit-legend pull-left" id="edit_legend">
                    <div class="form_main_block">
                        <h3>
                            <label class="control-label">Legend</label>
                            <div class="checkbox" style="display: inline-block">
                                <input type="checkbox" class="js-switch-small" prop_key="show" id="legend_show" name="legend_show" "="" key_path="options.legend.show" checked="checked" data-switchery="true" style="display: none;">
                                <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                    <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small>
                                </span>
                            </div>
                        ...
                        <div class="legendform">
                            <div class="form_main_block pull-left">
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_orient">Orient</label>
                                    <select class="form-control title_select select2-hidden-accessible" id="legend_orient" prop_key="orient" name="legend_orient" key_path="options.legend.orient" tabindex="-1" aria-hidden="true">
                                        <option value="horizontal">Horizontal</option>
                                        <option value="vertical">Vertical</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-legend_orient-container">
                                                <span class="select2-selection__rendered" id="select2-legend_orient-container"></span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_select_mode">Select Mode</label>
                                    <select class="form-control title_select select2-hidden-accessible" prop_key="selectedMode" name="legend_select_mode" key_path="options.legend.selectedMode" tabindex="-1" aria-hidden="true">
                                        <option value="single">Single</option>
                                        <option value="multiple">Multiple</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-legend_select_mode-2c-container">

                                                <span class="select2-selection__rendered" id="select2-legend_select_mode-2c-container"></span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                                ...
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_background_color">Background</label>
                                    <div class="color-button">
                                        <div class="input-group cl_picer cl_picer_noinput colorpicker-element">
                                            <input class="form-control" id="legend_background_color" type="text" prop_key="backgroundColor" name="legend_background_color" key_path="options.legend.backgroundColor">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_text_color">Text Color</label>
                                    <div class="color-button">
                                        <div class="input-group cl_picer cl_picer_noinput colorpicker-element">
                                            <input class="form-control" id="legend_text_color" type="text" prop_key="color" name="legend_text_color" key_path="options.legend.textStyle.color">
                            ...
                            <div class="form_main_block pull-left">
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_x_position">X</label>
                                    <select class="form-control title_select select2-hidden-accessible" id="legend_x_position" prop_key="x" name="legend_x_position" key_path="options.legend.x" tabindex="-1" aria-hidden="true">
                                        <option value="">&nbsp;</option>
                                        <option value="center">Center</option>
                                        <option value="left">Left</option>
                                        <option value="right">Right</option>
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-legend_x_position-container">
                                                <span class="select2-selection__rendered" id="select2-legend_x_position-container" title="&nbsp;">&nbsp;</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                                    </span>
                                    <label class="control-label control-label-custom-legend2">OR</label>
                                    <input class="form-control title_input_small" id="legend_x_position_text" type="number" prop_key="x" name="legend_x_position_text" key_path="options.legend.x">
                                    <label class="control-label control-label-custom3 control_label_custom3">px</label>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_y_position">Y</label>
                                    <select class="form-control title_select select2-hidden-accessible" id="legend_y_position" prop_key="y" name="legend_y_position" key_path="options.legend.y" tabindex="-1" aria-hidden="true">
                                        <option value="">&nbsp;</option>
                                        <option value="center">Center</option>
                                        <option value="top">Top</option>
                                        <option value="bottom">Bottom</option>
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-legend_y_position-container">
                                                <span class="select2-selection__rendered" id="select2-legend_y_position-container" title="&nbsp;">&nbsp;</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                    ...
                                    <label class="control-label control-label-custom-legend2">OR</label>
                                    <input class="form-control title_input_small" id="legend_y_position_text" type="number" prop_key="y" name="legend_y_position_text" key_path="options.legend.y">
                                    <label class="control-label control-label-custom3 control_label_custom3">px</label>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_shape_width">Shape Width</label>
                                    <input class="form-control title_select" id="legend_shape_width" type="number" prop_key="itemWidth" name="legend_shape_width" key_path="options.legend.itemWidth">
                                    <label class="control-label control-label-custom-legend2" for="legend_shape_height">Height</label>
                                    <input class="form-control title_input_small" id="legend_shape_height" type="number" prop_key="itemHeight" name="legend_shape_height" key_path="options.legend.itemHeight">
                                    <label class="control-label control-label-custom3 control_label_custom3">px</label>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom-legend" for="legend_border_color">Border Color</label>
                                    <div class="color-button">
                                        <div class="input-group cl_picer cl_picer_noinput colorpicker-element">
                                            <input class="form-control" id="legend_border_color" type="text" prop_key="borderColor" name="legend_border_color" key_path="options.legend.borderColor">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                    </div>
                                    <label class="control-label control-label-custom-legend3" for="legend_border_width">Width</label>
                                    <input class="form-control title_input_small" id="legend_border_width" type="number" prop_key="borderWidth" name="legend_border_width" key_path="options.legend.borderWidth">
                                    <label class="control-label control-label-custom3 control_label_custom3">px</label>
                                </div>
                            </div>
                        </div>
        ...
        <div role="tabpanel" class="tab-pane fade in" id="tab_display" aria-labelledby="display-tab">
            <div class="row"><div class="forms" id="edit_display">
                    <div class="form_main_block">
                        <div class="form-horizontal form-label-left edit-display pull-left">
                            <div class="form_main_block pull-left">
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom" for="display_charttype">Type</label>
                                    <select class="form-control title_input_small select2-hidden-accessible" id="display_charttype" prop_key="type" name="display_charttype" key_path="type" tabindex="-1" aria-hidden="true">
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 74px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_charttype-container">
                                                <span class="select2-selection__rendered" id="select2-display_charttype-container" title="Lines">Lines</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true">                                                            
                                        </span></span><label class="control-label control-label-custom120" for="backgroundColor">Color</label>
                                    <div class="color-button">
                                        <div class="input-group cl_picer cl_picer_noinput colorpicker-element">
                                            <input class="form-control" id="backgroundColor" type="text" prop_key="backgroundColor" name="backgroundColor" key_path="options.backgroundColor">
                                            <span class="input-group-addon"><i></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom" for="display_animation">Animation</label>
                                    <div class="checkbox" style="display: inline-block">

                                        <input class="js-switch-small" id="display_animation" type="checkbox" prop_key="animation" name="display_animation" key_path="options.animation" checked="checked" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                            <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small>
                                        </span>
                                    </div>
                                    <label class="control-label control-label-custom155" for="display_containLabel">Contains label</label>
                                    <div class="checkbox" style="display: inline-block">
                                        <input class="js-switch-small" id="display_containLabel" type="checkbox" prop_key="containLabel" name="display_containLabel" key_path="options.grid.containLabel" checked="checked" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                            <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;">
                                            </small>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom"><label class="control-label control-label-custom" for="padding_left">Left</label><input class="form-control title_input_small" id="padding_left" type="text" prop_key="x" placeholder="auto" name="padding_left" key_path="options.grid.x">
                                    <label class="control-label control-label-custom120" for="padding_top">Top</label>
                                    <input class="form-control title_input_small" id="padding_top" type="text" prop_key="y" placeholder="auto" name="padding_top" key_path="options.grid.y">
                                </div>
                                <div class="form-group form-group-custom"><label class="control-label control-label-custom" for="padding_right">Right</label>
                                    <input class="form-control title_input_small" id="padding_right" type="text" prop_key="x2" placeholder="auto" name="padding_right" key_path="options.grid.x2">
                                    <label class="control-label control-label-custom120" for="padding_bottom">Bottom</label>
                                    <input class="form-control title_input_small" id="padding_bottom" type="text" prop_key="y2" placeholder="auto" name="padding_bottom" key_path="options.grid.y2">
                                </div>
                                <div class="form-group form-group-custom">
                                    <label class="control-label control-label-custom" for="padding_width">Width</label>
                                    <input class="form-control title_input_small" id="padding_width" type="text" prop_key="width" placeholder="auto" name="padding_width" key_path="options.grid.width">
                                    <label class="control-label control-label-custom120" for="padding_height">Height</label>
                                    <input class="form-control title_input_small" id="padding_height" type="text" prop_key="height" placeholder="auto" name="padding_height" key_path="options.grid.height">
                                </div>
                            </div>
                            <div class="form_main_block pull-left custominputs">
                                <h4 class="form-group typeline typebars">
                                    <label class="control-label">Options</label>
                                </h4>
                                <div class="form-group form-group-custom typeline">
                                    <label class="control-label control-label-custom" for="display_points">Points</label>
                                    <select class="form-control title_select select2-hidden-accessible" id="display_points" prop_key="points" name="display_points" key_path="points" tabindex="-1" aria-hidden="true">
                                        ...
                                        <option value="emptyRectangle">Empty Rectang</option>
                                        <option value="emptyTriangle">Empty Triangl</option>
                                        <option value="emptyDiamond">Empty Diamond</option>
                                    </select>
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_points-container">
                                                <span class="select2-selection__rendered" id="select2-display_points-container" title="None">None</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="form-group form-group-custom typeline">
                                    <label class="control-label control-label-custom" for="display_fillArea">Fill Area</label>
                                    <select class="form-control title_select select2-hidden-accessible" id="display_fillArea" prop_key="fill" name="display_fillArea" key_path="fill" tabindex="-1" aria-hidden="true">
                                        <option value="none">None</option>
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_fillArea-container">
                                                <span class="select2-selection__rendered" id="select2-display_fillArea-container" title="None">None</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>                                                            
                                ...
                                <div class="form-group form-group-custom typeline">
                                    <label class="control-label control-label-custom" for="display_steped">Staircase</label>
                                    <select class="form-control title_select select2-hidden-accessible" id="step" prop_key="step" name="display_steped" key_path="step" tabindex="-1" aria-hidden="true">
                                        <option value="">None</option>
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 90px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-step-container">
                                                <span class="select2-selection__rendered" id="select2-step-container" title="None">None</span>                                                                
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                                ...
                                <div class="form-group form-group-custom typeline typebars">
                                    <label class="control-label control-label-custom" for="display_stacked">Stacked</label>
                                    <div class="checkbox" style="display: inline-block">
                                        <input class="js-switch-small" id="display_stacked" type="checkbox" prop_key="stacked" name="display_stacked" key_path="stacked" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; border-color: rgb(223, 223, 223); background-color: rgb(255, 255, 255); transition: border 0.4s, box-shadow 0.4s;">
                                            <small style="left: 0px; transition: background-color 0.4s, left 0.2s;"></small>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group form-group-custom typeline">
                                    <label class="control-label control-label-custom" for="display_smooth">Smooth</label>
                                    <div class="checkbox" style="display: inline-block">
                                        <input class="js-switch-small" id="display_smooth" type="checkbox" prop_key="smooth" name="display_smooth" key_path="smooth" checked="checked" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                            <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small>
                                        </span>
                                    </div>
                            ...
                            <div class="form_main_block pull-left custominputs" id="axes_select"><h4 class="form-group typeline typebars typemap typepie typefunnel">
                                    <label class="control-label">Labels</label>
                                </h4>
                                <div class="form-group form-group-custom typeline typebars typemap">
                                    <label class="control-label control-label-custom120" for="display_label_pos">Position</label>
                                    <select class="form-control axes_select select2-hidden-accessible" id="display_label_pos" prop_key="label.position" name="display_label_pos" key_path="label.position" tabindex="-1" aria-hidden="true">                                                        
                                        <option value="top">Top</option>
                                        <option value="left">Left</option>
                                        <option value="right">Right</option>
                                        <option value="bottom">Bottom</option>
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_label_pos-container">
                                                <span class="select2-selection__rendered" id="select2-display_label_pos-container" title="Inside">Inside</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                                ...
                                <div class="form-group form-group-custom typefunnel" style="display: none;">
                                    <label class="control-label control-label-custom120" for="display_label_pos">Position</label>
                                    <select class="form-control axes_select select2-hidden-accessible" id="display_label_pos" prop_key="label.position" name="display_label_pos" key_path="label.position" tabindex="-1" aria-hidden="true">
                                        <option value="left">Left</option>
                                        <option value="right">Right</option>
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_label_pos-container">
                                                <span class="select2-selection__rendered" id="select2-display_label_pos-container"></span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                                ...
                                <div class="form-group form-group-custom typepie" style="display: none;">
                                    <label class="control-label control-label-custom120" for="display_label_pos">Position</label>
                                    <select class="form-control axes_select select2-hidden-accessible" id="display_label_pos" prop_key="label.position" name="display_label_pos" key_path="label.position" tabindex="-1" aria-hidden="true">
                                    ...
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_label_pos-container"><span class="select2-selection__rendered" id="select2-display_label_pos-container" title="Outside">Outside</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span></div><div class="form-group form-group-custom typepie" style="display: none;"><label class="control-label control-label-custom120" for="display_label_parts">Format <i class="fa fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="{a1},{a2},{value},{p}-Will be replaced by actual Alias, Secondary Alias and Value "></i></label>
                                    <input class="form-control axes_select query_input display_label_parts" id="display_label_parts" type="text" prop_key="parts" name="display_label_parts" key_path="label.parts">
                                </div>
                                <div class="form-group form-group-custom typemap typefunnel typeline typebars">
                                    <label class="control-label control-label-custom120" for="display_label_parts">Format <i class="fa fas fa-info-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="{a1},{a2},{value}-Will be replaced by actual Alias, Secondary Alias and Value "></i></label>
                                    <input class="form-control axes_select query_input display_label_parts" id="display_label_parts" type="text" prop_key="parts" name="display_label_parts" key_path="label.parts">
                                </div>
                                <div class="form-group form-group-custom typeline typebars">
                                    <label class="control-label control-label-custom120" for="display_label">Show</label>
                                    <div class="checkbox" style="display: inline-block">
                                        <input class="js-switch-small" id="display_label" type="checkbox" prop_key="label.show" name="display_label" key_path="label.show" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; border-color: rgb(223, 223, 223); background-color: rgb(255, 255, 255); transition: border 0.4s, box-shadow 0.4s;">
                                            <small style="left: 0px; transition: background-color 0.4s, left 0.2s;"></small>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom typepie typefunnel typemap" style="display: none;">
                                    <label class="control-label control-label-custom120" for="display_label_2">Show</label>
                                    <div class="checkbox" style="display: inline-block">
                                        <input class="js-switch-small" id="display_label_2" type="checkbox" prop_key="label.show" name="display_label_2" key_path="label.show" checked="checked" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                            <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small>
                                        </span>
                                    </div>
                            ...
                            <div class="form_main_block pull-left custominputs">
                                <h4 class="form-group typeline">
                                    <label class="control-label">Tooltip</label></h4>
                                <div class="form-group form-group-custom typeline">
                                    <label class="control-label control-label-custom120" for="display_trig">Trigger On</label>
                                    <select class="form-control axes_select select2-hidden-accessible" id="display_trig" prop_key="triggerOn" name="display_trig" key_path="options.tooltip.triggerOn" tabindex="-1" aria-hidden="true">                                                            
                                        <option value="mousemove">Move</option>                                                            
                                        <option value="click">Click</option>                                                        
                                    </select>                                                        
                                    <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 196px;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-display_trig-container">
                                                <span class="select2-selection__rendered" id="select2-display_trig-container" title="Move">Move</span>
                                                <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                            </span>
                                        </span>
                                        <span class="dropdown-wrapper" aria-hidden="true"></span>
                            ...
                            <div class="form_main_block pull-left custominputs" id="axes_select">
                                <h4 class="form-group typegauge" style="display: none;"><label class="control-label">Detail</label></h4>
                                <label class="control-label control-label-custom120 typegauge" for="detailColor" style="display: none;">Color</label>
                                <div class="titile_input_midle typegauge" style="display: none;">
                                    <div class="input-group cl_picer cl_picer_input colorpicker-element">
                                        <input class="form-control" id="detailColor" type="text" prop_key="backgroundColor" name="detailColor" key_path="detail.color">
                                        <span class="input-group-addon"><i></i></span>
                                    </div>
                                </div>
                                <div class="form-group form-group-custom typegauge" style="display: none;">
                                    <label class="control-label control-label-custom120" for="display_label_gauge">Show</label>
                                    <div class="checkbox" style="display: inline-block"><input class="js-switch-small" id="display_label_gauge" type="checkbox" prop_key="label.show" name="display_label_gauge" key_path="label.show" checked="checked" data-switchery="true" style="display: none;">
                                        <span class="switchery switchery-small" style="background-color: rgb(38, 185, 154); border-color: rgb(38, 185, 154); box-shadow: rgb(38, 185, 154) 0px 0px 0px 0px inset; transition: border 0.4s, box-shadow 0.4s, background-color 1.2s;">
                                            <small style="left: 22px; background-color: rgb(255, 255, 255); transition: background-color 0.4s, left 0.2s;"></small>
                                        </span>
                                    </div>
        ...
        <div role="tabpanel" class="tab-pane fade in" id="tab_time" aria-labelledby="time-tab">
            <div class="row"><form class="form-horizontal form-label-left edit-times pull-left" id="edit_time">
                    <div class="form_main_block">
                        <div class="form-group form-group-custom filter">
                            <label class="control-label pull-left" for="padding_height">Times</label>
                            <div class="pull-left" id="reportrange_private" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                                <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                <span></span>
                                <b class="caret"></b>
                            </div>
                            <div class="pull-left" id="refresh_wrap_private">
                                <select id="refreshtime_private" name="refreshtime" style="width: 150px" key_path="times.intervall" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">                                                    
                                    <option value="General">Refresh General</option>
                                ...
                                <span class="select2 select2-container select2-container--default" dir="ltr" style="width: 150px;">
                                    <span class="selection">
                                        <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-refreshtime_private-container">
                                            <span class="select2-selection__rendered" id="select2-refreshtime_private-container">
                                            </span>
                                            <span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>
                                        </span>
                                    </span>
        ...
        <div role="tabpanel" class="tab-pane fade in" id="tab_json" aria-labelledby="json-tab">
            <div class="row">
                <form class="edit-ljson" id="edit_json">
                    <div class="form_main_block">
                        <h3><label class="control-label">Json Editor</label></h3>
                        <div id="jsoneditor"><div class="jsoneditor jsoneditor-mode-code">
                                <div class="jsoneditor-menu">
                                    <button type="button" class="jsoneditor-format" title="Format JSON data, with proper indentation and line feeds (Ctrl+\)"></button>
                                    <button type="button" class="jsoneditor-compact" title="Compact JSON data, remove all whitespaces (Ctrl+Shift+\)"></button>
                                    <div class="jsoneditor-modes" style="position: relative;">
                                        <button type="button" class="jsoneditor-modes jsoneditor-separator" title="Switch editor mode">Code ▾</button>
                                    </div>
                                    <a href="http://ace.ajax.org" target="_blank" class="jsoneditor-poweredBy">powered by ace</a>
                                </div>
                                <div class="jsoneditor-outer">
                                    <div class=" ace_editor ace-jsoneditor" style="height: 100%; width: 100%; font-size: 13px;">
                                        <textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0;"></textarea>
                                        ...
                                        <div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: hidden;">
                                            <div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">
                                            </div>
                                            <div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                            <button class="btn btn-primary" id="jsonReset" type="button">Reset</button>
                            <button class="btn btn-primary" id="jsonApply" type="button">Apply</button>
                        </div>
                    </div>
                </form>
            </div>
