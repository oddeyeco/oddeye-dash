                        ...
                        <form class="form-horizontal form-label-left edit-title">
                            ...
                            <div class="title_main_block" >
                                ...
                                <div id="position_block" style="display: none;">
                                    <div class="row">
                                        <label for="title_x_position" class="control-label col-md-2">
                                            X
                                        </label>
                                        <div class="col-md-3">
                                            <select id="title_x_position" chart_prop_key="x" name="title_x_position" class="title_select form-control" style="width: 100px;">
                                                <option selected value=""></option>
                                                <option value="center">Center</option>
                                                <option value="left">Left</option>
                                                <option value="right">Right</option>
                                    ...
                                    <div class="row">
                                        <label for="title_y_position" class="control-label col-md-2">
                                            Y
                                        </label> 
                                        <div class="col-md-3">
                                            <select id="title_y_position" chart_prop_key="y" name="title_y_position" class="title_select form-control" style="width: 100px;">
                                                <option selected value=""></option>
                                                <option value="center">Center</option>
                                                <option value="top">Top</option>
                                                <option value="bottom">Bottom</option>
                                ...
                                <div id="color_block" style="display: none;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3" style="margin-left: -70px; width: 240px;"">
                                            <div class="input-group cl_picer" >                            
                                                <input id="title_background_color" chart_prop_key="backgroundColor" name="title_background_color" type="text" value="" class="form-control" >
                                                <span class="input-group-addon"><i></i></span>
                                            </div>                                
                                    ...
                                    <div class="row">
                                        <label for="title_border_color" class="control-label col-md-2" style="text-align: right !important;">
                                            Border
                                        </label>
                                        <div class="col-md-3" style="margin-left: 7px; width: 240px;">
                                            <div class="input-group cl_picer">                            
                                                <input id="title_border_color" name="title_border_color" chart_prop_key="borderColor" type="text" value="" class="form-control" >
                                                <span class="input-group-addon"><i></i></span>
                                            </div>                                
                                ...
                                <div id="border_block" style="display: none;">
                                    <div class="row">
                                        <label for="title_border_width" class="control-label col-md-2" style="text-align: right !important;">
                                            Width
                                        </label>
                                        <div class="col-md-1">
                                            <input id="title_border_width" chart_prop_key="borderWidth" name="title_border_width" type="number" value="" class="title_input form-control col-md-1 col-xs-12" style="width: 70px;">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label for="title_border_color" class="control-label col-md-2" style="text-align: right !important;">
                                        ...
                                        <div class="col-md-3" style="margin-top: 5px; width: 240px;">
                                            <div class="input-group cl_picer">                            
                                                <input id="title_border_color" name="title_border_color" chart_prop_key="borderColor" type="text" value="" class="form-control" >
                                                <span class="input-group-addon"><i></i></span>
                                            </div>                                
