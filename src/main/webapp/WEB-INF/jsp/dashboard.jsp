    ...
    <div class="raw widgetraw">
        <div class="raw-controls text-right">   
            ...
            <div class="btn-group  btn-group-xs">
                <a class="btn btn-default addstatus btn-default-dash" type="button" data-toggle="tooltip" data-placement="top" title='<spring:message code="dashboard.title.addStatusWidget"/>' ><i class="fas fa-sort-amount-up"></i></a>
