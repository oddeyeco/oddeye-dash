...
<html lang="en">
  ...
  <body class="nav-md">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Vlo vloyan
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#canvas_dahs").length && $.plot($("#canvas_dahs"), [
          ...
          colors: ["rgba(38, 185, 154, 0.38)", "rgba(3, 88, 106, 0.38)", "rgba(255, 0, 0, 0.3)"],
          xaxis: {
    ...
    <!-- jVectorMap -->
    <script src="${cp}/resources/js/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script src="${cp}/resources/js/maps/jquery-jvectormap-us-aea-en.js"></script>
    <script src="${cp}/resources/js/maps/gdp-data.js"></script>
    <script>
      $(document).ready(function(){
